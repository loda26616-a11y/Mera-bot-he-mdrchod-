...
BOT_TOKEN = "8307172728:AAGc5LEm-5G_mPmXIGEAmBmlC8pSfm8zhjo"
ADMIN_ID = 7806238707
FORCE_CHANNEL = "@NyraPremiumMembershipChannel"
...
async def plan(update,context):
    ...
    if data["qr"]:
        ...
        await query.message.reply_text("⚠️ Admin has not set QR yet")
